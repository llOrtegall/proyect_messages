  ...
  return (<div className="h-screen w-full flex items-center justify-center">
    <Card className="w-full max-w-md shadow-xl rounded-2xl border border-gray-200 bg-white/80 backdrop-blur-md">
      <CardHeader className="flex flex-col items-center gap-2">
        ...
        <CardTitle className="text-2xl font-bold text-gray-800">Register New Acount</CardTitle>
      </CardHeader>
      <CardContent>
        ...
        <div className="mt-4 text-center text-sm text-gray-600">
          ...
          <Button
            ...
            variant="link" className="px-0 text-pink-500 hover:text-blue-500 transition">
            Sign in
          </Button>
        </div>
      </CardContent>
